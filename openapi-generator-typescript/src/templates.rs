...
impl TemplateGenerator {
    ...
    pub fn new() -> Result<Self, minijinja::Error> {
        ...
        env.add_template("interface", include_str!("../snippets/interface.j2"))?;
        env.add_template("type_alias", include_str!("../snippets/type_alias.j2"))?;
        env.add_template("enum", include_str!("../snippets/enum.j2"))?;
        env.add_template("class", include_str!("../snippets/class.j2"))?;
        env.add_template("function", include_str!("../snippets/function.j2"))?;
