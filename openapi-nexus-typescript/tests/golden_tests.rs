...
use openapi_nexus_typescript::config::GeneratorConfig;
...
fn test_runtime_generation() {
    ...
    let config = openapi_nexus_typescript::config::GeneratorConfig::default();
    let generator = TsLangGenerator::new(config);
    ...
    assert!(
        runtime_file
            .content
            .contains("DO NOT EDIT - This file is automatically generated")
    );
